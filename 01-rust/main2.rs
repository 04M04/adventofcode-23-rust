fn main() {
    ...
    for elem in &input_list {
        let mut list_of_numbers = Vec::new();
        let mut elem_string = elem.to_string();
        for _c in elem.to_string().chars(){
            if elem_string.starts_with("one") || elem_string.starts_with("1"){ list_of_numbers.push(1); }
            else if elem_string.starts_with("two") || elem_string.starts_with("2"){ list_of_numbers.push(2); }
            else if elem_string.starts_with("three") || elem_string.starts_with("3"){ list_of_numbers.push(3); }
            else if elem_string.starts_with("four") || elem_string.starts_with("4"){ list_of_numbers.push(4); }
            else if elem_string.starts_with("five") || elem_string.starts_with("5"){ list_of_numbers.push(5); }
            else if elem_string.starts_with("six") || elem_string.starts_with("6"){ list_of_numbers.push(6); }
            else if elem_string.starts_with("seven") || elem_string.starts_with("7"){ list_of_numbers.push(7); }
            else if elem_string.starts_with("eight") || elem_string.starts_with("8"){ list_of_numbers.push(8); }
            else if elem_string.starts_with("nine") || elem_string.starts_with("9"){ list_of_numbers.push(9); }
            let _ = elem_string.remove(0);
        }
        if list_of_numbers.len() > 1 {
            result += 10 * list_of_numbers[0] + list_of_numbers[list_of_numbers.len() - 1];
        }
        else {
            result += 10 * list_of_numbers[0] + list_of_numbers[0];
        }
